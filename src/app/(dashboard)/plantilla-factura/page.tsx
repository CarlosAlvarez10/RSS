...
import { activeCai, invoices, money } from "@/lib/dashboard-data";
  ...
  return (
    <>
      <PageHeader
        ...
        actions={
          <>
            ...
            <ActionButton onClick={() => setSaved(true)}>Guardar plantilla</ActionButton>
          </>
        }
      />
      ...
      <div className="grid gap-5 p-5 xl:grid-cols-[420px_1fr]">
        ...
        <section className="rounded-lg border border-slate-200 bg-slate-200 p-4 md:p-8">
          <div className="mx-auto min-h-[980px] max-w-[820px] bg-white p-8 shadow-sm md:p-12">
            <header
            ...
            >
              ...
              <div className="text-left md:text-right">
                ...
                <div className="mt-4 rounded-md border border-slate-200 bg-slate-50 p-3">
                  ...
                  <p className="mt-1 break-all font-mono text-xs text-slate-800">{activeCai?.cai}</p>
                </div>
              </div>
            </header>
            ...
            <section className="grid gap-6 border-b border-slate-200 py-6 md:grid-cols-2">
              ...
              <div className="md:text-right">
                ...
                <p className="text-sm text-slate-600">Rango autorizado: 001-002-01-{String(activeCai?.initial).padStart(8, "0")} al 001-002-01-{String(activeCai?.final).padStart(8, "0")}</p>
                <p className="text-sm text-slate-600">Fecha límite: {activeCai?.limitDate}</p>
              </div>
            </section>
